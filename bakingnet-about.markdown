...
| Tezos docker build | [tezos/tezos:octez-v25.2](https://hub.docker.com/r/tezos/tezos/tags?page=1&ordering=last_updated&name=octez-v25.2) |
...
```
docker run -it --entrypoint=/bin/sh tezos/tezos:octez-v25.2
```
...
### Join the Bakingnet network

Run the following commands:

```
octez-node config init --network https://teztnets.com/bakingnet
...
| | RPC | P2P Endpoint |
|------------|---------|--------------|
| DAL Bootstrap | [Link](https://dal-bootstrap-rpc.bakingnet.teztnets.com/p2p/gossipsub/scores) | `dal.bakingnet.teztnets.com:11732` |
| DAL Teztnets Attester | [Link](https://dal-attester-rpc.bakingnet.teztnets.com/p2p/gossipsub/scores) | `dal1.bakingnet.teztnets.com:11732` |
...
### Bake on the Bakingnet network

To improve reliability of the chain, you can take part in the consensus by becoming a baker. In that case, you will need some test tokens from the [faucet](https://faucet.bakingnet.teztnets.com).
