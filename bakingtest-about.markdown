...
To join Bakingtest with docker, open a shell in the container:
...
### Join the Bakingtest network

Run the following commands:

```
octez-node config init --network https://teztnets.com/bakingtest
...
```
wget -O snapshot_file https://snapshots.tzinit.org/bakingtest/rolling
...
| | RPC | P2P Endpoint |
|------------|---------|--------------|
| DAL Bootstrap | [Link](https://dal-bootstrap-rpc.bakingtest.teztnets.com/p2p/gossipsub/scores) | `dal.bakingtest.teztnets.com:11732` |
| DAL Teztnets Attester | [Link](https://dal-attester-rpc.bakingtest.teztnets.com/p2p/gossipsub/scores) | `dal1.bakingtest.teztnets.com:11732` |
...
### Bake on the Bakingtest network

To improve reliability of the chain, you can take part in the consensus by becoming a baker. In that case, you will need some test tokens from the [faucet](https://faucet.bakingtest.teztnets.com).
