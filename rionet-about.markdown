...
| Tezos docker build | [tezos/tezos:octez-v22.0-rc2](https://hub.docker.com/r/tezos/tezos/tags?page=1&ordering=last_updated&name=octez-v22.0-rc2) |
...
```
docker run -it --entrypoint=/bin/sh tezos/tezos:octez-v22.0-rc2
```
