...
```
docker run -it --entrypoint=/bin/sh tezos/tezos:master_ef7e2a5b_20260407155711
```
...
```
octez-node config init --network https://teztnets.com/weeklynet-2026-04-08
...
| | RPC | P2P Endpoint |
|------------|---------|--------------|
| DAL Bootstrap | [Link](https://dal-bootstrap-rpc.weeklynet-2026-04-08.teztnets.com/p2p/gossipsub/scores) | `dal.weeklynet-2026-04-08.teztnets.com:11732` |
| DAL Teztnets Attester | [Link](https://dal-attester-rpc.weeklynet-2026-04-08.teztnets.com/p2p/gossipsub/scores) | `dal1.weeklynet-2026-04-08.teztnets.com:11732` |
