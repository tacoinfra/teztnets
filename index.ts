...
const weeklynet_chain = new TezosChain(
  {
    ...
    chartRepoVersion: "8.0.3", // point to a release of tezos-k8s. This should be the default state.
...
const ghostnetRollingVersion = "octez-v24.3";
const ghostnetArchiveVersion = "octez-v24.3";
...
const nextnet_chain = new TezosChain(
  {
    ...
    activationBucket: activationBucket,
    helmValuesFile: "networks/nextnet-u-20260320/values.yaml",
    bakingPrivateKey: private_teztnets_baking_key,
    bootstrapPeers: [],
    rpcUrls: [],
    indexers: [],
...
new TezosFaucet(
  nextnet_chain.name,
  {
    ...
    humanName: "Nextnet-U-20260320",
    helmValuesFile: "networks/nextnet-u-20260320/faucet_values.yaml",
    faucetPrivateKey: faucetPrivateKey,
    faucetRecaptchaSiteKey: faucetRecaptchaSiteKey,
    faucetRecaptchaSecretKey: faucetRecaptchaSecretKey,
    chartRepoVersion: "8.0.2",
